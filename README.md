...
gonzo is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running gonzo Locally

You can test your hubot by running the following.

You can start gonzo locally by running:
...
Then you can interact with gonzo by typing `gonzo help`.

    gonzo> gonzo help

    gonzo> animate me <query> - The same thing as `image me`, except adds a few
